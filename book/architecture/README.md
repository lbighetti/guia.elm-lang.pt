...
A Arquitetura Elma é um padrão simples para arquitetar webapps. É ótimo para modularização, reutlização de código, e teste. Ultimamente, ele tem tornado fácil de criar aplicações complexas que se mantem saudáveis quando refatoradas e adicionadas novas funcionalidades.
